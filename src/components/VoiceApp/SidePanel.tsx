  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-gray-900">{t.personaTitle}</h2>
        <div className="flex items-center space-x-2">
          <button 
            onClick={() => ui.setIsSettingsModalOpen(true)} 
            className="p-2 rounded-lg hover:bg-gray-100 bg-white border border-gray-300 transition-colors"
            aria-label="Settings"
          >
