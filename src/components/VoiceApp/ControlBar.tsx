        ...
        <button
          ...
          className={`p-4 rounded-full transition-all shadow-lg text-white font-bold ${
            session.status !== 'IDLE' && session.status !== 'ERROR' 
              ? 'bg-accent2 hover:bg-red-600 hover:scale-105 border-2 border-red-600' 
              : 'bg-accent hover:bg-green-600 hover:opacity-90 hover:scale-105 border-2 border-green-600'
          }`}
